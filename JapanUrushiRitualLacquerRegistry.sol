...
contract JapanUrushiRitualLacquerRegistry {

    struct LacquerTechnique {
        string region;        // Wajima, Kiso, Echizen
        string workshop;      // lacquer studios or artisan lineages
        string techniqueName; // urushi coating, maki-e, kintsugi, etc.
        string materialType;  // raw urushi sap, gold powder, wood base
        string culturalNote;  // historical or cultural context
        string ritualUse;     // ceremonial bowls, Noh masks, tea utensils
        address creator;
        uint256 likes;
        uint256 dislikes;
        uint256 createdAt;
    ...
    LacquerTechnique[] public techniques;
    ...
    function voteTechnique(uint256 id, bool like) external {
        ...
        LacquerTechnique storage t = techniques[id];
